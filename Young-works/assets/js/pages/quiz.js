...
function displayQuestion() {
  ...
  currentQuestion.options.forEach((option, index) => {
    ...
    optionElement.addEventListener('click', () => {
      ...
      // Salva a resposta e exibe o botão "Próxima"
      handleAnswer(index);
...
function showResults() {
  ...
  const courses = [
    {
      informacoes: "/pages/informacoes-area/front-end/index.html",
    ...
    {
      informacoes: "/pages/informacoes-area/back-end/index.html",
    ...
    {
      informacoes: "/pages/informacoes-area/aplicativo(Mobile)/index.html",
    ...
    {
      informacoes: "/pages/informacoes-area/devops/index.html",
      area: "DevOps",
