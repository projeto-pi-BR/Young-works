...
function displayQuestion() {
  ...
  // Oculta botão "Next" inicialmente
  nextButton.style.display = 'none';

  // Atualiza barra de progresso e contador
  const totalQuestions = questions.length;
  document.getElementById("progress-text").textContent = `Pergunta ${currentQuestionIndex + 1} de ${totalQuestions}`;
...
function showResults() {
  ...
  // Esconde a barra de progresso ao final do quiz
  ...
  const courses = [
    {
      informacoes: "/pages/quiz/informacoes-area/front-end/index.html",
      area: "Desenvolvimento Web",
      course: "Desenvolvimento Web Completo com HTML, CSS, JavaScript",
      platform: "Udemy",
    ...
    {
      informacoes: "/pages/quiz/informacoes-area/back-end/index.html",
    ...
    {
      informacoes: "/pages/quiz/informacoes-area/aplicativo(Mobile)/index.html",
    ...
    {
      informacoes: "/pages/quiz/informacoes-area/devops/index.html",
      area: "DevOps",
